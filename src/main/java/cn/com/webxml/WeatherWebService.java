 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/workspace/wolf_study/src/main/java/com/study/webservice/weather.wsdl")
public class WeatherWebService
    extends Service
{

    private final static URL WEATHERWEBSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(cn.com.webxml.WeatherWebService.class.getName());
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/E:/workspace/wolf_study/src/main/java/com/study/webservice/weather.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/E:/workspace/wolf_study/src/main/java/com/study/webservice/weather.wsdl', retrying as a local file");
