 ...
 */
public class CustomerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument
{
     ...
     */
    public com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument.Customer getCustomer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument.Customer target = null;
            target = (com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument.Customer)get_store().find_element_user(CUSTOMER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCustomer(com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument.Customer customer)
    {
     ...
     * This is a complex type.
     */
    public static class CustomerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bull.eris.ten.assessEngine.xml.dto.CustomerDocument.Customer
    {
        private static final long serialVersionUID = 1L;
        ...
        public com.bull.eris.ten.assessEngine.xml.dto.GenderDocument.Gender xgetGender()
        {
            synchronized (monitor())
            {
                ...
                target = (com.bull.eris.ten.assessEngine.xml.dto.GenderDocument.Gender)get_store().find_element_user(GENDER$2, 0);
                return target;
            }
        }
        ...
        public void xsetGender(com.bull.eris.ten.assessEngine.xml.dto.GenderDocument.Gender gender)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.bull.eris.ten.assessEngine.xml.dto.GenderDocument.Gender)get_store().add_element_user(GENDER$2);
                }
                target.set(gender);
            }
        }
        ...
        public com.bull.eris.ten.assessEngine.xml.dto.AddressDocument.Address getAddress()
        {
            synchronized (monitor())
            {
                ...
                target = (com.bull.eris.ten.assessEngine.xml.dto.AddressDocument.Address)get_store().find_element_user(ADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public com.bull.eris.ten.assessEngine.xml.dto.AddressDocument.Address addNewAddress()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.bull.eris.ten.assessEngine.xml.dto.AddressDocument.Address target = null;
                target = (com.bull.eris.ten.assessEngine.xml.dto.AddressDocument.Address)get_store().add_element_user(ADDRESS$10);
                return target;
            }
        }
    }
