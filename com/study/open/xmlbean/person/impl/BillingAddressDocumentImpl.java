 ...
 */
public class BillingAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.study.open.xmlbean.person.BillingAddressDocument
{
    ...
    public com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress getBillingAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress)get_store().find_element_user(BILLINGADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress addNewBillingAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress target = null;
            target = (com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress)get_store().add_element_user(BILLINGADDRESS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BillingAddressImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.study.open.xmlbean.person.BillingAddressDocument.BillingAddress
    {
        private static final long serialVersionUID = 1L;
