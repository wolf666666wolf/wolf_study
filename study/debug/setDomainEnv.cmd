...
@REM (http://download.oracle.com/docs/cd/E14571_01/web.1111/e13708/overview.htm).
@REM *************************************************************************
...
set SUN_JAVA_HOME=%DOMAIN_HOME%\jdk1.6.0_24
...
if "%JAVA_VENDOR%"=="Oracle" (
	...
	if "%JAVA_VENDOR%"=="Sun" (
		...
		set JAVA_VENDOR=Sun
		set JAVA_HOME=%DOMAIN_HOME%\jdk1.6.0_24
	)
)
...
set DOMAIN_HOME=E:\Oracle\Middleware\user_projects\domains\DEV
for %%i in ("%DOMAIN_HOME%") do set DOMAIN_HOME=%%~fsi

set LONG_DOMAIN_HOME=E:\Oracle\Middleware\user_projects\domains\DEV
